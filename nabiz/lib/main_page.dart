...
import 'package:nabiz/widgets/action_button.dart';
...
class _MainPageState extends State<MainPage> {
  ...
  Widget _controlBT() {
    return SwitchListTile(
      ...
      title: Text(
        _bluetoothState ? "Bluetooth Açık" : "Bluetooth Kapalı",
      ),
    );
  }
  ...
  Widget _infoDevice() {
    return ListTile(
      ...
      title: Text("Bağlı cihaz: ${_deviceConnected?.name ?? "hiçbiri"}"),
      trailing: _connection?.isConnected ?? false
          ...
          : TextButton(
              ...
              child: const Text("Cihazları görüntüle"),
            ),
    );
  }
